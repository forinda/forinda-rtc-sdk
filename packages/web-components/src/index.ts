 ...
 * `<forinda-video-publisher>`, `<forinda-video-viewer>`, and
 * `<forinda-video-device-picker>` with `customElements`. Use
 * `@forinda/video-sdk-elements/manual` if you need to register manually
 * (e.g., to control timing or use a custom tag name).
 */
